<script lang="ts">
	import { tagSchema, type TagSchema } from '$lib/components/tags/schema';
	...
	let {
		createForm,
		open = $bindable()
	}: { createForm: SuperValidated<Infer<TagSchema>>; open: boolean } = $props();
