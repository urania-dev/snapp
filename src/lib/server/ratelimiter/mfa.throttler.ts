export class Throttler<_Key> {
	...
	public getRemainingTime(key: _Key): number | null {
		...
		const remainingTime = this.timeoutSeconds[counter.index] * 1000 - timeElapsed;
...
const throttler = new Throttler<string>([30, 60 * 15, 60 * 30, 60 * 60, 60 * 60 * 2, 60 * 60 * 12, 60 * 60 * 24]);
