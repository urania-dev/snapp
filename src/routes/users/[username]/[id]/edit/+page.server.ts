...
import { ALLOW_UNSECURE_HTTP, MAX_SNAPPS_PER_USER, SNAPP_ORIGIN_URL_BLACKLISTED, SNAPP_ORIGIN_URL_REQUESTED, UNAUTHORIZED } from "$lib/utils/constants.js";
import { fail, redirect } from "@sveltejs/kit";


export const load = async ({ locals: { session, user }, request, params: { id, username }, url }) => {
